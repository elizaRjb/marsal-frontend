...
import { GET_PROJECTS_LIST, CREATE_PROJECT, setProjectsList, updateProjectsList } from 'actions/projects';
...
export default function* projectSaga() {
  yield all([watchGetProjectsListRequest(), watchCreateProjectRequest()]);
}
